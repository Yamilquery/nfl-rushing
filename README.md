...
To start your API server:
  ...
  * Start Elixir endpoint with `mix run --no-halt`

To start your React-App:

  * Go to `cd react_app`
  * Install dependencies with `yarn` or `npm install`
  * Start Elixir endpoint with `yarn start` or `npm start`

Now you can visit [`localhost:3000`](http://localhost:3000) from your browser.

### Test

Run the `mix test` command to run the tests.
